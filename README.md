...
I'm a software engineer with a strong foundation in **systems design, AI/ML engineering, and full stack development**. I enjoy working across the stack — from designing fault-tolerant backend services and optimizing databases, to building and deploying machine learning models, to crafting polished, intuitive frontend experiences. My approach blends rigorous engineering practices with a product-first mindset, focused on shipping software that is reliable, scalable, and genuinely useful.

I've contributed to projects spanning **distributed systems, generative AI applications, cloud-native infrastructure, and consumer-facing products**, with an emphasis on clean architecture, test coverage, and performance at scale.
...
*"Great software isn't just written — it's engineered with purpose, precision, and care."*

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:6a3093,50:302b63,100:0f0c29&height=120&section=footer"/>
